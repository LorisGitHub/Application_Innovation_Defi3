...
from tensorflow.keras.layers import Dense, Activation, Softmax, BatchNormalization
...
model = Sequential()
# entre 1 et 512 et entre 1 et 3 couches
model.add(Dense(1, input_shape=(103,), activation='relu'))
...
model.fit(x_train, y_train, epochs=20, verbose=1, validation_data=(x_test, y_test), callbacks=[checkpointAccuracy])
